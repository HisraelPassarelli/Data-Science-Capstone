setwd("~/Aula R/Coursera/Data Science Specialization/10 Data Science Capstone")
...
bi_words <- readRDS("./ngram_match/bi_words_fast.rds")
tri_words  <- readRDS("./ngram_match/tri_words_fast.rds")
quad_words <- readRDS("./ngram_match/quad_words_fast.rds")
